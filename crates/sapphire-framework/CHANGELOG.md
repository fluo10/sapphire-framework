...
## [0.15.0](https://github.com/fluo10/sapphire-framework/compare/sapphire-framework-v0.14.0...sapphire-framework-v0.15.0) - 2026-09-17

### Added

- *(registry)* [**breaking**] drop users; every device belongs to one person
- *(sync)* scaffold sapphire-framework-sync with value types
...
- unify the tagline — human-agent collaboration, drop the fossil tagline ([#135](https://github.com/fluo10/sapphire-framework/pull/135))
- *(registry)* record the per-device file format
